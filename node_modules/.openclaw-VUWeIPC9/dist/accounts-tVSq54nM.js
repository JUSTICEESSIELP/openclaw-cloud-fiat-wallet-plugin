...
import { _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId } from "./session-key-DfPy1nVI.js";
import { i as isPrivateOrLoopbackHost } from "./net-ufRGHFYT.js";
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-DsdpNeM3.js";
import { s as resolveMergedAccountConfig } from "./account-helpers-DZTIJt7q.js";
import "./secret-input-CePTSrcF.js";
import "./config-runtime-CAAXFgt9.js";
import { a as ssrfPolicyFromAllowPrivateNetwork, t as assertHttpUrlTargetsPrivateNetwork } from "./ssrf-policy-Cxb3Pbba.js";
import "./account-resolution-NZ3yYbo4.js";
import { d as requiresExplicitMatrixDefaultAccount, f as resolveConfiguredMatrixAccountIds, h as getMatrixScopedEnvVarNames, m as resolveMatrixDefaultOrOnlyAccountId } from "./storage-paths-CFd31Pey.js";
import { a as findMatrixAccountConfig, c as resolveMatrixBaseConfig, s as listNormalizedMatrixAccountIds, t as resolveMatrixConfigFieldPath } from "./config-update-C49pCqAW.js";
import { t as resolveMatrixAccountStringValues } from "./auth-precedence-DDurrZ9D.js";
import "./runtime-api-D4Hwn1tB.js";
import { t as getMatrixRuntime } from "./runtime-uO7jw-2K.js";
import { t as MatrixClient } from "./sdk-Cfbivjf_.js";
import { n as ensureMatrixSdkLoggingConfigured, o as LogService } from "./logging-B-Hzyhi0.js";
import { i as writeStorageMeta, r as resolveMatrixStoragePaths, t as maybeMigrateLegacyStorage } from "./storage-BSl2c1PR.js";
import { n as loadMatrixCredentials, t as credentialsMatchConfig } from "./credentials-read-CmHQFlVY.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-EgVvQFqL.js"), import("./logging-DrUtg8o9.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-DOpWskkT.js").then((credentialsReadModule) => ({
...
async function resolveMatrixAuth(params) {
	...
	const loadCredentialsWriter = async () => {
		credentialsWriter ??= await import("./credentials-write.runtime-DBCqQEZY.js");
