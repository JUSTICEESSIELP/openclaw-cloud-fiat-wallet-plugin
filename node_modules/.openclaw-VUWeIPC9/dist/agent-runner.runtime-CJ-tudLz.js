...
import { _ as resolveRunModelFallbacksOverride, v as resolveSessionAgentId } from "./agent-scope-C9FCuuJ_.js";
import { s as isCliProvider } from "./model-selection-Cd76ZREp.js";
import { c as loadConfig } from "./io-BIM51zl6.js";
import "./config-BtX72IOx.js";
import { o as isInternalMessageChannel, p as resolveMessageChannel, s as isMarkdownCapableMessageChannel } from "./message-channel-B0WkAV8D.js";
import { C as resolveGroupSessionKey, d as updateSessionStore, f as updateSessionStoreEntry, i as loadSessionStore } from "./store-DACjypj4.js";
import "./sessions-BT8kziwu.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, r as resolveSessionFilePath } from "./paths-ChI21wgR.js";
import { a as resolveFreshSessionTotalTokens } from "./types-DBri4NCZ.js";
import { a as isAudioFileName } from "./mime-QHK1kq9n.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-pwrtZIYQ.js";
import { a as stripHeartbeatToken } from "./heartbeat-CGE-y10X.js";
import { u as resolveMemoryFlushPlan } from "./memory-state-CsQ1um_b.js";
import { An as buildFallbackClearedNotice, Bn as scheduleFollowupDrain, D as readPostCompactionContext, E as estimateMessagesTokens, Gn as isFallbackSummaryError, Kn as runWithModelFallback, Ln as enqueueFollowupRun, Mn as resolveFallbackTransition, Rt as emitAgentEvent, Vn as refreshQueuedFollowupSession, Vt as registerAgentRunContext, _ as queueEmbeddedPiMessage, b as compactEmbeddedPiSession, jn as buildFallbackNotice, t as runEmbeddedPiAgent, u as LiveSessionModelSwitchError } from "./pi-embedded-iRgRpYxO.js";
import { a as generateSecureUuid } from "./secure-random-jqntG1LL.js";
import { n as isDiagnosticsEnabled, t as emitDiagnosticEvent } from "./diagnostic-events-DuH-FGrZ.js";
...
import { n as resolveSandboxConfigForAgent } from "./config-C-FN-elV.js";
import { a as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./sandbox-paths-I3M16w_4.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-MA0Rl6K6.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-PhfX6ZlT.js";
import { s as resolveModelAuthMode } from "./model-auth-BmdDDGyy.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-CGw8Bg_w.js";
...
import { h as resolvePathFromInput, o as parseReplyDirectives, p as resolveEffectiveToolFsWorkspaceOnly } from "./deliver-_62Nfy6l.js";
import { i as isRenderablePayload, n as applyReplyThreading, o as createReplyToModeFilterForChannel, s as resolveReplyToMode, t as applyReplyTagsToPayload } from "./reply-payloads-BdB5EJP4.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-CS_QQCBq.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-U7LkOWun.js";
import { t as lookupContextTokens } from "./context-cMbFks3m.js";
import { c as hasNonzeroUsage, o as derivePromptTokens, s as deriveSessionTotalTokens, u as normalizeUsage } from "./chat-envelope-BOKZM4ae.js";
import { a as formatTokenCount, i as estimateUsageCost, o as formatUsd, s as resolveModelCostConfig } from "./strip-inbound-meta-CTErxdJB.js";
import { _ as readSessionMessages } from "./session-utils-PHKOUUva.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-COcXHFWg.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-DopvQRKq.js";
import { t as createTypingSignaler } from "./typing-mode-3Y-2dbGn.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-C3-mQBHX.js";
import { a as setCliSessionBinding, o as setCliSessionId, r as getCliSessionBinding, t as runCliAgent } from "./cli-runner-qwYT7_lW.js";
import { a as resolveModelFallbackOptions, i as isBunFetchSocketError, o as resolveRunAuthProfile, r as formatBunFetchSocketError, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-B5GMCkMM.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-p9JanHeB.js";
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-DndTWc4P.js");
