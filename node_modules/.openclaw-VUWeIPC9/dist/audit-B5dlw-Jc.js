...
import { t as DEFAULT_AGENT_ID } from "./session-key-DfPy1nVI.js";
import { Y as listRiskyConfiguredSafeBins, q as normalizeTrustedSafeBinDirs } from "./io-BIM51zl6.js";
...
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-RDyCXbZA.js";
...
import { $ as resolveBrowserConfig, X as redactCdpUrl, et as resolveBrowserControlAuth, rt as resolveProfile } from "./browser-runtime-D9ST3vsJ.js";
import "./sandbox-MA0Rl6K6.js";
import { l as isInterpreterLikeAllowlistPattern } from "./exec-approvals-allowlist-Iiw0_9xQ.js";
...
import { i as loadExecApprovals } from "./exec-approvals-DVqmcC44.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CsMMFtZR.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-DfDUlSku.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-DXyO81f0.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-CN5iqa0H.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-DLFBoGeo.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-COtvuyM0.js"),
		import("./probe-auth-FAS4PB5H.js"),
		import("./probe-BzWCJQRo.js")
