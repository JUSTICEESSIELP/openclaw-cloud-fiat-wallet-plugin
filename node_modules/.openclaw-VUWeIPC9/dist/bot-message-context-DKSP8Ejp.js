...
import { d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-DfPy1nVI.js";
...
import { t as firstDefined } from "./allow-from-Bj0HDNYh.js";
...
import { a as buildPendingHistoryContextFromMap, u as recordPendingHistoryEntryIfEnabled } from "./history-CG-1pklz.js";
...
import { a as createStatusReactionController, n as DEFAULT_EMOJIS } from "./channel-feedback-D2TOpT5s.js";
...
async function resolveStickerVisionSupport(params) {
	try {
		const { resolveStickerVisionSupportRuntime } = await import("./sticker-vision.runtime-D2CUHvcg.js");
...
async function resolveTelegramInboundBody(params) {
	...
	if (isGroup && requireMention && hasAudio && !hasUserText && mentionRegexes.length > 0 && !disableAudioPreflight && senderAllowedForAudioPreflight) try {
		const { transcribeFirstAudio } = await import("./media-understanding.runtime-BwwH_5qP.js");
