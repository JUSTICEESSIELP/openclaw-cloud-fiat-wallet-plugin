...
import { r as loadAuthProfileStore } from "./store-17P65JdK.js";
...
import { m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-C9FCuuJ_.js";
...
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-C6TNvpE7.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-Bd3ZDZYP.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-BNU1Xq0_.js";
...
import { r as createMessageActionDiscoveryContext, s as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-HeO5wKHM.js";
...
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-k73tIcpV.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-e-P06DMK.js";
import { t as createClackPrompter } from "./clack-prompter-PSD2DAOd.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CJb2KPsf.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-BDJr1LnV.js";
import { t as parseLogLine } from "./parse-log-line-BBLmvYye.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-BcCf1ILL.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-CLk2gQsF.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-D8znfN4D.js"), import("./onboard-channels-coApr_DB.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-Dfs4Hl21.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-Dfs4Hl21.js");
			const prompter = createClackPrompter();
