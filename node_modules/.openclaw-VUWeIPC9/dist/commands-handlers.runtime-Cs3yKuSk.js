...
import { _ as normalizeAccountId, v as normalizeOptionalAccountId } from "./session-key-DfPy1nVI.js";
import { r as normalizeStringEntries } from "./string-normalization-CmGlAIu6.js";
import { v as resolveSessionAgentId } from "./agent-scope-C9FCuuJ_.js";
import { A as setConfigValueAtPath, D as unsetConfigOverride, E as setConfigOverride, O as getConfigValueAtPath, R as validateConfigObjectWithPlugins, T as resetConfigOverrides, f as readConfigFileSnapshot, j as unsetConfigValueAtPath, k as parseConfigPath, w as getConfigOverrides, x as writeConfigFile } from "./io-BIM51zl6.js";
import { o as normalizeChannelId } from "./registry-C0lW5OhB.js";
import { t as clearPluginManifestRegistryCache } from "./manifest-registry-DQYIYJ9K.js";
...
import { _ as GATEWAY_CLIENT_NAMES, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, o as isInternalMessageChannel } from "./message-channel-B0WkAV8D.js";
import { d as updateSessionStore, i as loadSessionStore } from "./store-DACjypj4.js";
import { t as getChannelPlugin } from "./registry-B44RoJBS.js";
import "./plugins-NUJfWIB7.js";
import "./sessions-BT8kziwu.js";
import { i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-ChI21wgR.js";
import { a as resolveFreshSessionTotalTokens } from "./types-DBri4NCZ.js";
import { tn as ErrorCodes } from "./method-scopes-D3wXggJU.js";
import { r as callGateway } from "./call-h8FrADrE.js";
import { r as isRestartEnabled, t as isCommandFlagEnabled } from "./commands-B8xYWHi5.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-BL_iSRXc.js";
...
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-BSsu_r6B.js";
import { $ as findTaskByRunIdForOwner, $t as readAcpSessionEntry, B as spawnSubagentDirect, Er as getSession, Fn as resolveFastModeState, K as resolveAcpThreadSessionDetailLines, Kt as formatRunLabel, O as stripToolResultDetails, On as formatContextUsageShort, Qn as scheduleGatewaySigusr1Restart, Tr as getFinishedSession, W as resolveAcpSessionCwd, Xt as sortSubagentRuns, _t as sendControlledSubagentMessage, b as compactEmbeddedPiSession, bt as countPendingDescendantRuns, dr as createExecTool, dt as buildSubagentList, f as abortEmbeddedPiRun, ft as killAllControlledSubagentRuns, h as isEmbeddedPiRunActive, ht as listControlledSubagentRuns, kn as formatTokenCount, m as getActiveEmbeddedRunSnapshot, or as stripToolMessages, pt as killControlledSubagentRun, s as EmbeddedBlockChunker, tr as triggerOpenClawRestart, vt as steerControlledSubagentRun, y as waitForEmbeddedPiRunEnd, zn as clearSessionQueues } from "./pi-embedded-iRgRpYxO.js";
import { t as diag } from "./diagnostic-CqyEa1UW.js";
import { r as enqueueSystemEvent } from "./system-events-C-cm81w-.js";
import { t as formatDurationCompact } from "./format-duration-CnYLC5qz.js";
import "./sandbox-MA0Rl6K6.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-PhfX6ZlT.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-Bd1dbB-c.js";
import { n as getApiKeyForModel } from "./model-auth-BmdDDGyy.js";
import { _ as resolveModelWithRegistry, i as listSpeechProviders, n as canonicalizeSpeechProviderId, r as getSpeechProvider } from "./directives-CfdMe1YZ.js";
import { C as textToSpeech, _ as setSummarizationEnabled, a as getTtsMaxLength, b as setTtsMaxLength, c as isTtsEnabled, g as setLastTtsAttempt, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsPrefsPath, o as getTtsProvider, p as resolveTtsConfig, r as getLastTtsAttempt, s as isSummarizationEnabled, x as setTtsProvider, y as setTtsEnabled } from "./tts-RItDwGuz.js";
import "./thinking-COal-Sfg.js";
import { t as ensureOpenClawModelsJson } from "./models-config-KyFi5MCD.js";
import { n as setPluginEnabledInConfig } from "./enable-DMUBPvDe.js";
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-RYotT7Of.js";
import { n as parseActivationCommand } from "./group-activation-C9TJVXSl.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-DKNFfVKa.js";
import { a as formatTokenCount$1, o as formatUsd } from "./strip-inbound-meta-CTErxdJB.js";
import { p as normalizeCommandBody } from "./commands-registry-BS02OahC.js";
import { c as resolveThreadBindingIdleTimeoutMsForChannel, d as resolveThreadBindingMaxAgeMsForChannel, g as formatThreadBindingDurationLabel, i as formatThreadBindingSpawnDisabledError, p as resolveThreadBindingSpawnPolicy, r as formatThreadBindingDisabledError, v as resolveThreadBindingIntroText, y as resolveThreadBindingThreadName } from "./thread-bindings-policy-VzX605z8.js";
import { n as createPluginRuntime } from "./runtime-9DLN_Ai5.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-_-xKy4sy.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-Dp7QCrz1.js";
import { a as resolveArchiveKind } from "./archive-BDZ9ruzy.js";
import { r as formatElevatedUnavailableMessage } from "./reply-B8i7ZpFD.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-D32cd2JP.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-NkW4tAQJ.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-DyZ7l9Ic.js";
import { t as extractBtwQuestion } from "./btw-command-CRS-aDE6.js";
import { c as rejectUnauthorizedCommand, l as requireCommandFlagEnabled, o as buildDisabledCommandReply, r as handleModelsCommand, s as rejectNonOwnerCommand, u as requireGatewayClientScopeForInternalChannel } from "./commands-models-BmW7Cnms.js";
import { S as resolveCommandSurfaceChannel, _ as resolveTelegramConversationId, a as formatLogLines, b as isTelegramSurface, c as resolveCommandSubagentController, d as resolveFocusTargetSession, f as resolveHandledPrefix, g as stopWithText, h as resolveSubagentsAction, i as buildSubagentsHelp, l as resolveDiscordChannelIdForFocus, m as resolveSubagentEntryForToken, o as formatTimestampWithAge, p as resolveRequesterSessionKey, s as loadSubagentSessionEntry, u as resolveDisplayStatus, v as isDiscordSurface, x as resolveChannelAccountId, y as isMatrixSurface } from "./targets-BW4-p5fs.js";
import { t as handleAcpCommand } from "./commands-acp-DGllckbc.js";
import { a as handleHelpCommand, c as handleWhoamiCommand, i as handleExportSessionCommand, n as handleCommandsListCommand, o as handleStatusCommand, r as handleContextCommand, s as handleToolsCommand } from "./commands-info-DxYr07bY.js";
import { i as isTelegramExecApprovalClientEnabled, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-JYbDbUU_.js";
import "./api-DW5bhWLp.js";
import { n as incrementCompactionCount } from "./session-updates-BW_JLtq5.js";
import { t as parseConfigValue } from "./config-value-BpTjaP5A.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-C6FdAhKM.js";
import { s as parseClawHubPluginSpec } from "./clawhub-DKYzvNhM.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-DtMAYXp_.js";
import { r as installPluginFromClawHub } from "./clawhub-QxVyeBgS.js";
import { a as buildPluginStatusReport, i as buildPluginInspectReport, o as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-DEMIwYCy.js";
import { a as decidePreferredClawHubFallback, f as resolveFileNpmSpecToLocalPath, i as createPluginInstallLogger, n as buildPreferredClawHubSpec } from "./plugins-command-helpers-K9Yd_YC0.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-BFZgnwNj.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-BsAfOgYh.js");
		killProcessTree(pid);
