...
import { f as readConfigFileSnapshot, z as OpenClawSchema } from "./io-BIM51zl6.js";
import "./config-BtX72IOx.js";
import { n as formatConfigIssueLines } from "./issue-format-DEtaWC1D.js";
import { t as note } from "./note-VEobHf5X.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-CvYplzIl.js");
