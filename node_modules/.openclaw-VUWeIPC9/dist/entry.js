...
if (!isMainModule({
	...
	const { installGaxiosFetchCompat } = await import("./gaxios-fetch-compat-DlJYjARj.js");
	...
	function tryHandleRootVersionFastPath(argv) {
		...
		Promise.all([import("./version-Dw-U-Mrc.js"), import("./git-commit-ButQox1_.js")]).then(([{ VERSION }, { resolveCommitHash }]) => {
...
function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	import("./root-help-CGV47omH.js").then(({ outputRootHelp }) => {
...
function runMainOrRootHelp(argv) {
	...
	import("./run-main-Cv4tme_8.js").then(({ runCli }) => runCli(argv)).catch((error) => {
