...
import { r as listTelegramAccountIds, s as resolveTelegramAccount } from "../../accounts-XoXj4DGm.js";
import { i as telegramOutbound } from "../../status-issues-C-_QEihE.js";
import { n as resolveTelegramFetch } from "../../fetch-nEVNrPAx.js";
import { i as resetTelegramThreadBindingsForTests, l as handleTelegramAction, s as telegramMessageActionRuntime } from "../../monitor-TTeZk3M4.js";
import { _ as sendPollTelegram, g as sendMessageTelegram } from "../../sticker-cache-1Tf7t-45.js";
import { n as setTelegramRuntime, t as telegramPlugin } from "../../channel-tYYn1FDf.js";
...
async function loadBuildTelegramMessageContext() {
	...
	if (!buildTelegramMessageContextLoader) ({buildTelegramMessageContext: buildTelegramMessageContextLoader} = await import("../../bot-message-context-BZWwP7lH.js"));
	return buildTelegramMessageContextLoader;
}
async function loadVitestModule() {
	vitestModuleLoader ??= import("../../dist-DTsYXd0s.js");
