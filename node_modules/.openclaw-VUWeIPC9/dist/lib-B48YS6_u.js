...
import { t as require_src } from "./src-CTC_Oi04.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-mw2jcNhP.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-BWIK_qqV.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-DibxFomu.js";
import { l as toRatio, n as decodeString } from "./Util-DdaUlKL0.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-BA4Wg3mo.js";
import { t as APEv2Parser } from "./APEv2Parser-Bn2UC8ad.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DBp1RIEk.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-C1tsBazZ.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DEcTBxl-.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-Bi7bsJxo.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DkfSub63.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-Cs6jN1yF.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BiYLWHjb.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-VJpDujt5.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-D-4FXMIz.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-os0FcGnl.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-y6x75zvt.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-5Hltm44-.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-D3jR_vP0.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-D8jHkRLb.js")).WaveParser;
	}
};
//#endregion
