...
import { s as registerUnhandledRejectionHandler } from "./unhandled-rejections-CK777psP.js";
...
import { _ as normalizeAccountId, d as resolveThreadSessionKeys } from "./session-key-DfPy1nVI.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId } from "./agent-scope-C9FCuuJ_.js";
import { g as resolveDefaultModelForAgent } from "./model-selection-Cd76ZREp.js";
import { Bt as resolveAgentMaxConcurrent, c as loadConfig, o as getRuntimeConfigSnapshot, x as writeConfigFile } from "./io-BIM51zl6.js";
import { d as normalizeTelegramCommandName, f as resolveTelegramCustomCommands, u as TELEGRAM_COMMAND_NAME_PATTERN } from "./zod-schema.providers-core-vnYz7m5r.js";
import { c as resolveSessionStoreEntry, d as updateSessionStore, i as loadSessionStore } from "./store-DACjypj4.js";
import { l as resolveStorePath } from "./paths-ChI21wgR.js";
import { c as getAgentScopedMediaLocalRoots, d as MediaFetchError, t as loadWebMedia } from "./web-media-CB_Im8DW.js";
import "./web-media-f8jDXTIh.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled, n as isNativeCommandsExplicitlyDisabled } from "./commands-B8xYWHi5.js";
import { _ as resolveChannelConfigWrites } from "./channel-config-helpers-BdJf9lkc.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-BL_iSRXc.js";
import { n as writeJsonFileAtomically } from "./json-store-BeYHnGQC.js";
import { c as jsonResult, d as readNumberParam, f as readReactionParams, h as readStringParam, m as readStringOrNumberParam, p as readStringArrayParam } from "./common-CkaXLLtf.js";
import { m as dispatchPluginInteractiveHandler, v as getPluginCommandSpecs } from "./types-DX2vikpM.js";
import { t as createDedupeCache } from "./dedupe-CpV1oUd0.js";
import { a as registerSessionBindingAdapter, o as unregisterSessionBindingAdapter } from "./session-binding-service-DvtTrxR0.js";
import { f as parsePluginBindingApprovalCustomId, i as buildPluginBindingResolvedText, m as resolvePluginConversationBindingApproval } from "./conversation-binding-PTXDIoxc.js";
import { wn as buildCommandsMessagePaginated } from "./pi-embedded-iRgRpYxO.js";
import { n as isDiagnosticsEnabled } from "./diagnostic-events-DuH-FGrZ.js";
import { _ as startDiagnosticHeartbeat, f as logWebhookError, m as logWebhookReceived, p as logWebhookProcessed, v as stopDiagnosticHeartbeat } from "./diagnostic-CqyEa1UW.js";
import { r as resolvePollMaxSelections } from "./polls-D9egmDCg.js";
import { r as enqueueSystemEvent } from "./system-events-C-cm81w-.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-CXAHrS-w.js";
import "./channel-runtime-DMhBbHvu.js";
import { p as resolveSendableOutboundReplyParts } from "./reply-payload-CqgHNqKP.js";
import { t as waitForAbortSignal } from "./abort-signal-QAEeWJ9O.js";
import { r as formatDurationPrecise } from "./format-duration-CnYLC5qz.js";
import "./runtime-env-ESYEM3cX.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-Cc-mf4Ul.js";
import "./text-runtime-X59jrcDB.js";
import { n as findCodeRegions, r as isInsideCode, t as stripReasoningTagsFromText } from "./reasoning-tags-P74pdidb.js";
import { a as buildExecApprovalPendingReplyPayload, u as parseExecApprovalCommandText } from "./exec-approval-reply-srzNUt2_.js";
import { _ as formatReasoningMessage } from "./minimax-vlm-DZuKqWFu.js";
import { a as modelSupportsVision, n as findModelInCatalog, r as loadModelCatalog } from "./model-catalog-BXIkCW63.js";
import { r as makeProxyFetch } from "./proxy-fetch-DXEvNUHB.js";
import { t as readBooleanParam } from "./boolean-param-B2kt8Cdy.js";
import { i as resolveAgentRoute } from "./resolve-route-BdS-gVow.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-DKNFfVKa.js";
import { d as listNativeCommandSpecsForConfig, g as resolveCommandArgMenu, m as parseCommandArgs, n as buildCommandTextFromArgs, r as findCommandByNativeName, u as listNativeCommandSpecs } from "./commands-registry-BS02OahC.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-BBc9KKeI.js";
import { c as resolveThreadBindingIdleTimeoutMsForChannel, d as resolveThreadBindingMaxAgeMsForChannel, g as formatThreadBindingDurationLabel, o as resolveThreadBindingEffectiveExpiresAt, p as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-VzX605z8.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-CNJu3ccb.js";
import "./core-C34-w2tw.js";
import "./routing-CW6tYlj1.js";
import { t as resolveTelegramToken } from "./token-C3c7s7lO.js";
import { n as isAbortRequestText } from "./abort-primitives-_-xKy4sy.js";
import { t as finalizeInboundContext } from "./inbound-context-CoFzxOmG.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-CXhw0e1-.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-C_KjZRpO.js";
import { t as removeAckReactionAfterReply } from "./ack-reactions-fQfgAW2T.js";
import { t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-_tp47Zsm.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-Cl4Md5g2.js";
import { t as resolveCommandAuthorization } from "./command-auth-BKzE7QNG.js";
import { i as resolveStoredModelOverride } from "./model-selection-PDFHE-q1.js";
import { s as clearHistoryEntriesIfEnabled } from "./history-CG-1pklz.js";
import "./reply-history-C3F3DZM4.js";
import { a as resolveExecApprovalCommandDisplay, i as resolveExecApprovalSessionTarget, n as resolveApprovalRequestAccountId } from "./exec-approval-session-target-DxwOUQcZ.js";
import { n as createApproverRestrictedNativeApprovalAdapter } from "./approval-runtime-D6f7wbL-.js";
import { a as matchesApprovalRequestFilters, r as buildPluginApprovalPendingReplyPayload } from "./approval-renderers-CWgqMz30.js";
import "./config-runtime-CAAXFgt9.js";
import { n as isBtwRequestText } from "./btw-command-CRS-aDE6.js";
import { n as resolveAutoTopicLabelConfig, t as generateTopicLabel } from "./reply-runtime-BKf1SqtA.js";
import "./reply-dispatch-runtime-BNVRs-fD.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-BMh6F2N7.js";
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-RITAOp6e.js";
import { n as createExecApprovalChannelRuntime, t as resolveChannelNativeApprovalDeliveryPlan } from "./infra-runtime-BiOz69Rf.js";
import { o as readJsonBodyWithLimit } from "./http-body-C3mMscUb.js";
import "./ssrf-runtime-C337ESQD.js";
import "./media-runtime-CEUv6OCx.js";
import { n as recordInboundSessionMetaSafe, r as ensureConfiguredBindingRouteReady, t as resolveThreadBindingConversationIdFromBindingId } from "./conversation-runtime-C-L6-gan.js";
import "./agent-runtime-CZJ2BLwV.js";
import "./plugin-runtime-CgtuEt7F.js";
import "./gateway-runtime-7bpLX8a3.js";
import { n as formatModelsAvailableHeader, t as buildModelsProviderData } from "./commands-models-BmW7Cnms.js";
import { r as logTypingFailure, t as logAckFailure } from "./logging-BzT11EM8.js";
import { t as extractToolSend } from "./tool-send-2Py_pykU.js";
import { a as createFixedWindowRateLimiter, r as WEBHOOK_RATE_LIMIT_DEFAULTS } from "./webhook-memory-guards-BBC7KQa-.js";
import { r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-BpjPf1Qo.js";
import "./webhook-ingress-nAY-kUPK.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-BbTPeBAJ.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-tIa2VtBK.js";
import { t as buildCommandsPaginationKeyboard } from "./commands-info-DxYr07bY.js";
import "./command-auth-Cuk9jhU-.js";
import "./command-auth-native-DsPd2Hk2.js";
import "./error-runtime-165NLcsY.js";
import { a as listTokenSourcedAccounts, i as createUnionActionGate, r as resolveReactionMessageId, t as createMessageToolButtonsSchema } from "./channel-actions-DJuPljWY.js";
import { n as shouldDebounceTextInbound } from "./channel-inbound-e17uaZhc.js";
import { i as createFinalizableDraftLifecycle } from "./channel-lifecycle-CqoUOb6w.js";
import "./state-paths-RSsRm9Y-.js";
import "./telegram-core-NgQoin6w.js";
import { l as resolveTelegramPollActionGateState, n as listEnabledTelegramAccounts, r as listTelegramAccountIds, s as resolveTelegramAccount, t as createTelegramActionGate } from "./accounts-XoXj4DGm.js";
import { a as resolveTelegramTargetChatType } from "./targets-C5brwShK.js";
import { r as resolveTelegramTransport } from "./fetch-nEVNrPAx.js";
...
import { A as resolveTelegramStreamMode, D as resolveTelegramGroupAllowFromContext, E as resolveTelegramForumThreadId, I as isSenderAllowed, M as withResolvedTelegramForumFlag, N as normalizeTelegramReplyToMessageId, R as normalizeDmAllowFromWithStore, T as resolveTelegramForumFlag, d as buildTelegramGroupFrom, f as buildTelegramGroupPeerId, h as buildTelegramThreadParams, i as renderTelegramHtmlText, j as resolveTelegramThreadSpec, m as buildTelegramRoutingTarget, p as buildTelegramParentPeer, s as withTelegramApiErrorLogging, u as buildSenderName, x as getTelegramTextParts, y as extractTelegramForumFlag } from "./format-Dx27DOzY.js";
import { a as buildModelsKeyboard, c as getModelsPageSize, l as parseModelCallbackData, m as resolveTelegramInlineButtons, o as buildProviderKeyboard, p as resolveTelegramReactionLevel, s as calculateTotalPages, u as resolveModelSelection } from "./probe-CtWb3PPT.js";
import { C as isRecoverableTelegramNetworkError, D as tagTelegramNetworkError, E as isTelegramPollingNetworkError, S as wasSentByBot, T as isTelegramClientRejection, _ as sendPollTelegram, c as createForumTopicTelegram, d as editMessageReplyMarkupTelegram, f as editMessageTelegram, g as sendMessageTelegram, i as getCacheStats, l as deleteMessageTelegram, m as reactMessageTelegram, n as describeStickerImage, o as searchStickers, s as buildInlineKeyboard, t as cacheSticker, u as editForumTopicTelegram, v as sendStickerTelegram, w as isSafeToRetrySendError, y as sendTypingTelegram } from "./sticker-cache-1Tf7t-45.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-DAeBXHrK.js";
import { a as evaluateTelegramGroupPolicyAccess, c as resolveTelegramConversationRoute, i as evaluateTelegramGroupBaseAccess, n as enforceTelegramDmAccess, r as resolveTelegramGroupPromptSettings, s as resolveTelegramConversationBaseSessionKey, t as buildTelegramMessageContext } from "./bot-message-context-DKSP8Ejp.js";
import { n as readTelegramUpdateOffset, r as writeTelegramUpdateOffset } from "./update-offset-store-CmkCRrFx.js";
...
function toExecLikeRequest(request) {
...
function resolveTurnSourceTelegramOriginTarget(params) {
	...
	return {
		...
		accountId: turnSourceAccountId || void 0
	};
}
...
function telegramTargetsMatch(a, b) {
	const accountMatches = !a.accountId || !b.accountId || normalizeAccountId(a.accountId) === normalizeAccountId(b.accountId);
...
function resolveTelegramOriginTarget(params) {
	...
	if (turnSourceTarget && sessionTarget && !telegramTargetsMatch(turnSourceTarget, sessionTarget)) return null;
...
var TelegramExecApprovalHandler = class {
	...
	async deliverRequested(request) {
		...
		if (deliveryPlan.targets.length === 0) return [];
		...
		const sentMessages = [];
		for (const target of deliveryPlan.targets) try {
			await this.sendTyping(target.target.to, {
				cfg: this.opts.cfg,
				token: this.opts.token,
				accountId: this.opts.accountId,
				...typeof target.target.threadId === "number" ? { messageThreadId: target.target.threadId } : {}
			}).catch(() => {});
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-D390NEJg.js");
