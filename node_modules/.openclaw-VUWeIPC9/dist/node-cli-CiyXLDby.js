...
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES } from "./message-channel-B0WkAV8D.js";
import { n as loadOrCreateDeviceIdentity } from "./device-identity-h2vahoK-.js";
import { u as GatewayClient } from "./method-scopes-D3wXggJU.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-BrUE0QAH.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-BNCoqy-f.js";
import { t as parsePort } from "./parse-port-De1Rnp9F.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-V7HxBcMy.js";
import { d as getMachineDisplayName, n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-BJCAsa7N.js";
import { $ as resolveBrowserConfig, at as runBrowserProxyCommand } from "./browser-runtime-D9ST3vsJ.js";
import { a as resolveAllowAlwaysPatterns, c as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, s as describeInterpreterInlineEval, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-Iiw0_9xQ.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-CDoOJNxp.js";
import { S as requestJsonlSocket, _ as resolveExecApprovals, c as normalizeExecApprovals, g as requiresExecApproval, m as recordAllowlistUse, n as addAllowlistEntry, o as mergeExecApprovalsSocketDefaults, p as readExecApprovalsSnapshot, r as ensureExecApprovals, x as saveExecApprovals } from "./exec-approvals-DVqmcC44.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-D0z-0TT-.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-6AWHMltn.js";
import { t as formatHelpExamples } from "./help-format-C_0IjyhG.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-tUYALuZ8.js";
import { t as resolveNodeService } from "./node-service-BorAGlEn.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-Dc9WIhAS.js";
