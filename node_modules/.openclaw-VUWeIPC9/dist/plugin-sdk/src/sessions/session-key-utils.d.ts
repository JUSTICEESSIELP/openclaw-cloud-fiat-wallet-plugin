...
export declare function parseThreadSessionSuffix(sessionKey: string | undefined | null, options?: {
    channelHint?: string | null;
}): ParsedThreadSessionSuffix;
export declare function parseSessionConversationRef(sessionKey: string | undefined | null): ParsedSessionConversationRef | null;
