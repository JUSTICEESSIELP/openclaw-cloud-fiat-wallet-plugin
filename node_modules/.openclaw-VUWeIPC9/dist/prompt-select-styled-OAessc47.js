...
import { c as updateAuthProfileStoreWithLock, n as ensureAuthProfileStore } from "./store-17P65JdK.js";
import { r as formatAuthDoctorHint, t as resolveApiKeyForProfile } from "./auth-profiles-Dd-hr5kk.js";
...
import { T as parseAgentSessionKey, _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId } from "./session-key-DfPy1nVI.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-C9FCuuJ_.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-NliLe8k-.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-ClUkSaOY.js";
import { _ as resolveHooksGmailModel, a as getModelRefStatus, h as resolveConfiguredModelRef } from "./model-selection-Cd76ZREp.js";
import { Ft as resolveNormalizedProviderModelMaxTokens, G as isTrustedSafeBinPath, It as LEGACY_TALK_PROVIDER_ID, N as migrateLegacyConfig, Rt as normalizeTalkSection, W as getTrustedSafeBinDirs, Y as listRiskyConfiguredSafeBins, dt as resolveCommandResolutionFromArgv, f as readConfigFileSnapshot, q as normalizeTrustedSafeBinDirs, x as writeConfigFile } from "./io-BIM51zl6.js";
import { C as resolveDiscordPreviewStreamMode, E as resolveTelegramPreviewStreamMode, T as resolveSlackStreamingMode, b as formatSlackStreamModeMigrationMessage, w as resolveSlackNativeStreaming, x as formatSlackStreamingBooleanMigrationMessage } from "./zod-schema.providers-core-vnYz7m5r.js";
import { r as normalizeChatChannelId } from "./chat-meta-vnJDD9J6.js";
import "./registry-C0lW5OhB.js";
import { i as normalizePluginId } from "./config-state-BOS3dliM.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-DQYIYJ9K.js";
import "./config-BtX72IOx.js";
...
import { d as resolveProfileUnusableUntilForDisplay } from "./order-ahChgr2T.js";
import { t as repairOAuthProfileIdMismatch } from "./repair-CweCNLU3.js";
...
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-CZeYLoRA.js";
...
import { u as readGatewayTokenEnv } from "./credentials-C0z0_2gF.js";
import { a as resolveGatewayAuth } from "./auth-CJX7OcQ0.js";
...
import { n as listChannelPlugins, t as getChannelPlugin } from "./registry-B44RoJBS.js";
import "./plugins-NUJfWIB7.js";
import { i as resolveMainSessionKey } from "./main-session-CZ1Y76BP.js";
import { i as resolveAgentSessionDirs } from "./sessions-BT8kziwu.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-ChI21wgR.js";
import { d as shouldMoveSingleAccountChannelKey } from "./setup-helpers-C6TNvpE7.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-C36UApB6.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-h8FrADrE.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-8Ohapmo_.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-Dc-yAjqT.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-DFB9L0E6.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-CkRsJw-O.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-DGaWDgZR.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DKGi6xKz.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-D7rh6dgz.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-DeQflIS4.js";
...
import "./logging-S06_64Vm.js";
import { n as formatConfigIssueLines } from "./issue-format-DEtaWC1D.js";
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-DsdpNeM3.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-SNfoX74R.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-D9yNqDxF.js";
import { a as readChannelAllowFromStore } from "./pairing-store-BL_iSRXc.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-W3gJUhNK.js";
import { t as resolvePluginProviders } from "./providers.runtime-DyJtlt66.js";
import { d as DEFAULT_SANDBOX_IMAGE, l as DEFAULT_SANDBOX_BROWSER_IMAGE, r as resolveSandboxScope } from "./config-C-FN-elV.js";
import { Y as readBrowserVersion, nt as resolveGoogleChromeExecutableForPlatform, q as parseBrowserMajorVersion } from "./browser-runtime-D9ST3vsJ.js";
import "./sandbox-MA0Rl6K6.js";
import { o as resolveApiKeyForProvider } from "./model-auth-BmdDDGyy.js";
import { b as resolveBootstrapContextForRun, n as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-CGw8Bg_w.js";
import { H as resolveBootstrapMaxChars, W as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-DkH7p_Zm.js";
import { t as migrateLegacyWebSearchConfig } from "./legacy-web-search-pr6gJQa3.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-CDoOJNxp.js";
import { r as loadModelCatalog } from "./model-catalog-BXIkCW63.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-BdcsMXzq.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-DiFrhrnW.js";
import { i as listRouteBindings } from "./bindings-Dv19tQlP.js";
import { r as resolveActiveMemoryBackendConfig } from "./memory-runtime-DaxTWhba.js";
import { t as resolveMemorySearchConfig } from "./memory-search-CoiKcQCw.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-olaL381H.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-BHl3zWCh.js";
import { n as logConfigUpdated } from "./logging-CCgnjscr.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-C3-mQBHX.js";
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-B1150NOt.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-CG0hVg2_.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-BQeeeZZh.js";
import { i as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, n as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./memory-core-engine-runtime-B0wOGj4O.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-C_70msS5.js";
import { _ as DEFAULT_GOOGLE_API_BASE_URL } from "./memory-core-host-engine-embeddings-CCZp4Zj4.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-BqcnRLUS.js";
import { t as checkQmdBinaryAvailability } from "./memory-core-host-engine-qmd-Cb0AB_YO.js";
import "./memory-core-host-engine-storage-Cmv1Je7I.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BRhRdLa5.js";
import { a as buildPluginStatusReport, r as buildPluginCompatibilityWarnings } from "./status-DEMIwYCy.js";
import { t as note$1 } from "./note-VEobHf5X.js";
import { r as healthCommand } from "./health-DfbN7bp9.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-oGa5t0dG.js";
import { g as normalizeStoredCronJobs, n as runGatewayUpdate, t as runStartupMatrixMigration } from "./server-startup-matrix-migration-B6IJ0bAE.js";
import { i as normalizeTelegramAllowFromEntry, n as isNumericTelegramUserId, r as listTelegramAccountIds, t as inspectTelegramAccount } from "./read-only-account-inspect.telegram-CHi5MR08.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-BFr9_6T7.js";
import { n as runMatrixDoctorSequence, t as cleanStaleMatrixPluginConfig } from "./matrix-lKYZLR9t.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-CO4l2bJ0.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BhUz7evd.js";
import { t as formatHealthCheckFailure } from "./health-format-CnVCrjOp.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-BJ4JbBb2.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-Cx5W1vpE.js";
import { n as doctorShellCompletion } from "./doctor-completion-DccUxhDE.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CWMvtc-s.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-BZTENgrX.js";
import "./doctor-state-migrations-CWC3lfjo.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-B-5jC5gy.js";
