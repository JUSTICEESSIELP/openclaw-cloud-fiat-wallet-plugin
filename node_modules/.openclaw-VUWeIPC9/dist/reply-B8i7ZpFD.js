...
import { T as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-DfPy1nVI.js";
import { r as normalizeStringEntries, t as normalizeAtHashSlug } from "./string-normalization-CmGlAIu6.js";
import { a as resolveAgentDir, f as resolveAgentSkillsFilter, i as resolveAgentConfig, n as listAgentEntries, p as resolveAgentWorkspaceDir, v as resolveSessionAgentId } from "./agent-scope-C9FCuuJ_.js";
import { d as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-ClUkSaOY.js";
import { v as resolveModelRefFromString } from "./model-selection-Cd76ZREp.js";
import { M as applyMergePatch, c as loadConfig } from "./io-BIM51zl6.js";
...
import { d as normalizeMessageChannel, f as resolveGatewayMessageChannel, o as isInternalMessageChannel, r as isDeliverableMessageChannel } from "./message-channel-B0WkAV8D.js";
import { C as resolveGroupSessionKey, b as deriveSessionMetaPatch, d as updateSessionStore, i as loadSessionStore } from "./store-DACjypj4.js";
import { t as normalizeChatType } from "./chat-type-C7RL3WXY.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./registry-B44RoJBS.js";
import "./plugins-NUJfWIB7.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-CZ1Y76BP.js";
import { c as resolveAndPersistSessionFile, d as resolveSessionResetPolicy, f as resolveSessionResetType, l as evaluateSessionFreshness, p as resolveThreadFlag, u as resolveChannelResetConfig } from "./sessions-BT8kziwu.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-ChI21wgR.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-DBri4NCZ.js";
import { n as resolveSessionKey } from "./session-key-DacU7vQ8.js";
import { a as normalizeDeliveryContext, n as deliveryContextKey, o as normalizeSessionDeliveryFields, t as deliveryContextFromSession } from "./delivery-context-CLP28cE0.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-pwrtZIYQ.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-BXlZzyQd.js";
import { t as normalizeConversationText } from "./conversation-id-D0JrPmSB.js";
import { r as getSessionBindingService } from "./session-binding-service-DvtTrxR0.js";
import { n as createInternalHookEvent, p as triggerInternalHook } from "./internal-hooks-68HvSR_p.js";
import { Ar as isReasoningTagProvider, Dr as disposeSessionMcpRuntime, Fn as resolveFastModeState, In as resolveQueueSettings, Pr as getQueueSize, Sn as resolveAgentTimeoutMs, T as collectTextContentBlocks, jr as clearCommandLane } from "./pi-embedded-iRgRpYxO.js";
import { i as generateSecureToken } from "./secure-random-jqntG1LL.js";
import { n as createTypingStartGuard, r as createTypingKeepaliveLoop } from "./typing-DXwyq_a_.js";
import { r as enqueueSystemEvent } from "./system-events-C-cm81w-.js";
import { t as applyOwnerOnlyToolPolicy } from "./tool-policy-ZLsNmkQQ.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-PhfX6ZlT.js";
import { S as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-budget-CGw8Bg_w.js";
import { i as supportsXHighThinking } from "./thinking-COal-Sfg.js";
import { t as appendCronStyleCurrentTimeLine } from "./current-time-dvvkWkQW.js";
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-8T_39EIf.js";
import { t as buildOutboundSessionContext } from "./session-context-_bsE6M4t.js";
import { t as normalizeGroupActivation } from "./group-activation-C9TJVXSl.js";
import { t as resolveChannelModelOverride } from "./model-overrides-ClKD4dY7.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-CNJu3ccb.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-_-xKy4sy.js";
import { t as hasControlCommand } from "./command-detection-mt9vmJSz.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-CB8IfuVF.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-Bj8hd_T4.js";
import { t as finalizeInboundContext } from "./inbound-context-CoFzxOmG.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-BUd_PMhT.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-Dp7QCrz1.js";
import { n as parseInlineDirectives, t as isDirectiveOnly } from "./directive-handling.parse-D_MZzREm.js";
import { t as resolveCommandAuthorization } from "./command-auth-BKzE7QNG.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-DGWMJTu0.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-COcXHFWg.js";
import { t as buildCommandContext } from "./commands-context-ChfQl2PX.js";
import { t as extractExplicitGroupId } from "./group-id-CiOPu9sT.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-D32cd2JP.js";
import { n as resolveContextTokens, t as createModelSelectionState } from "./model-selection-PDFHE-q1.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-CF7S4Tpw.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-NkW4tAQJ.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-DopvQRKq.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-BNs-4TS3.js";
import { n as resolveTypingMode } from "./typing-mode-3Y-2dbGn.js";
import { i as resolveConversationBindingContextFromMessage, o as resolveEffectiveResetTargetSessionKey } from "./conversation-binding-input-Cu5XpbkK.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-BBzi4QnQ.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-Oziwczwv.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-ckljwPYr.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-Cy8axilr.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-BlYbU2DY.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-B_KqvJw9.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-BMkVzPZc.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-BU1ElUw4.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-BU1ElUw4.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		skillFilter
	}) : [];
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createOpenClawTools } = await import("./openclaw-tools.runtime-yZWDPtqL.js");
	...
	if (!isAbortRequestText(command.rawBodyNormalized) && sessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-D996RG-U.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (!isDirectiveOnly({
		...
		const { buildStatusReply } = await import("./commands.runtime-Kgz3o5ch.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-Kgz3o5ch.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-DEHCub1u.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-CUsovznk.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-CJ-tudLz.js");
	return agentRunnerRuntimePromise;
}
function loadRouteReplyRuntime() {
	routeReplyRuntimePromise ??= import("./route-reply.runtime-9m6uc4PP.js");
	return routeReplyRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-aToBnx3Y.js");
	return sessionUpdatesRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./store.runtime-DEHCub1u.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-BsdKhtIo.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-Cn-zYH4e.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-CVqX1zjx.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-BiGmSBNI.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-D4yzvz6n.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-DFHNeGME.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-BEw2lVcr.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-D1EqLKzU.js");
