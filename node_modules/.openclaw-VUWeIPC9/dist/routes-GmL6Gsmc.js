...
import { c as loadConfig, i as createConfigIO, o as getRuntimeConfigSnapshot, x as writeConfigFile } from "./io-BIM51zl6.js";
import { a as normalizePluginsConfig, o as resolveEffectiveEnableState } from "./config-state-BOS3dliM.js";
...
import { o as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-zHwbKJY0.js";
import { r as hasProxyEnvConfigured } from "./proxy-env-D19u0GGY.js";
import { d as resolvePinnedHostnameWithPolicy, l as isPrivateNetworkAllowedByPolicy, t as SsrFBlockedError } from "./ssrf-RDyCXbZA.js";
import { a as getImageMetadata, l as resizeToJpeg, r as buildImageResizeSideGrid, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-CY-160-s.js";
import { t as rawDataToString } from "./ws-CTuCIGk8.js";
import { r as ensurePortAvailable } from "./ports-D7rh6dgz.js";
import { i as generateSecureToken } from "./secure-random-jqntG1LL.js";
import "./logging-core-DvRjP2IQ.js";
import { t as parseBooleanValue } from "./boolean-CdrI4HXu.js";
import { n as deriveDefaultBrowserCdpPortRange, r as deriveDefaultBrowserControlPort } from "./port-defaults-9t5FKjTi.js";
import { a as ensureMediaDir, l as saveMediaBuffer } from "./store-yo-1tlMX.js";
import "./temp-path-BD30Eg6a.js";
import { a as ensureGatewayStartupAuth } from "./nodes.helpers-DQDctreU.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-Cd-b1raY.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-Cd-b1raY.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-Cd-b1raY.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
