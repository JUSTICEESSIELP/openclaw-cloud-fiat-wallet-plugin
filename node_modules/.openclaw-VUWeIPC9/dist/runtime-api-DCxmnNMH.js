...
import { nn as errorShape, tn as ErrorCodes } from "./method-scopes-D3wXggJU.js";
import { c as jsonResult, h as readStringParam, s as imageResultFromFile } from "./common-CkaXLLtf.js";
import { t as parseBooleanValue } from "./boolean-CdrI4HXu.js";
import { s as wrapExternalContent } from "./external-content-BeKQjNuG.js";
import { a as resolveNodeIdFromList, n as listNodes, o as selectDefaultNodeFromList, s as callGatewayTool } from "./with-timeout-BsfOSR_F.js";
import { i as stringEnum, r as optionalStringEnum } from "./typebox-fIQsXnEX.js";
import { t as startLazyPluginServiceModule } from "./lazy-service-module-DcyBig37.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-DQDctreU.js";
import { n as runCommandWithRuntime } from "./cli-utils-COshY7Fu.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-BPZ6oMQI.js";
import { t as formatHelpExamples } from "./help-format-C_0IjyhG.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-Cb9HeCq_.js";
import "./browser-support-HWAGcJXq.js";
import "./channel-actions-DJuPljWY.js";
import { A as resolveBrowserConfig, B as DEFAULT_UPLOAD_DIR, K as normalizeBrowserFormField, M as DEFAULT_AI_SNAPSHOT_MAX_CHARS, V as resolveExistingPathsWithinRoot, W as getBrowserProfileCapabilities, f as redactCdpUrl, g as createBrowserControlContext, h as createBrowserRouteDispatcher, j as resolveProfile, q as normalizeBrowserFormFieldValue, v as startBrowserControlServiceFromConfig } from "./routes-GmL6Gsmc.js";
import { C as browserConsoleMessages, D as browserArmFileChooser, E as browserArmDialog, O as browserNavigate, S as browserTabs, T as browserAct, _ as browserSnapshot, b as browserStop, c as persistBrowserProxyFiles, h as browserProfiles, i as isPersistentBrowserProfileMutation, k as browserScreenshotAction, m as browserOpenTab, n as trackSessionBrowserTab, o as resolveRequestedBrowserProfile, p as browserFocusTab, r as untrackSessionBrowserTab, s as applyBrowserProxyPaths, u as browserCloseTab, v as browserStart, w as browserPdfSave, y as browserStatus } from "./core-api-BRpr2fX4.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-D238LtA9.js"),
