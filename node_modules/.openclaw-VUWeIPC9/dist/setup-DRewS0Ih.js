...
import { f as readConfigFileSnapshot, x as writeConfigFile } from "./io-BIM51zl6.js";
...
async function resolveAuthChoiceModelSelectionPolicy(params) {
	...
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-CnlAhNKE.js");
...
async function runSetupWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./onboard-helpers-BviyMgOi.js");
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-DNjmBlSa.js");
		const { logConfigUpdated } = await import("./logging-DfGKEv_G.js");
	...
	const { applyLocalSetupWorkspaceConfig } = await import("./onboard-config-CI4qCbWl.js");
	let nextConfig = applyLocalSetupWorkspaceConfig(baseConfig, workspaceDir);
	const { ensureAuthProfileStore } = await import("./agents/auth-profiles.runtime.js");
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-B-q6Ydk5.js");
	const { promptCustomApiConfig } = await import("./onboard-custom-Cxg687SP.js");
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-aPGmsCPF.js");
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-D8H7qkI1.js");
	...
	const { configureGatewayForSetup } = await import("./setup.gateway-config-s8cvR2oB.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { listChannelPlugins } = await import("./plugins-DfDUlSku.js");
		const { setupChannels } = await import("./onboard-channels-coApr_DB.js");
	...
	if (opts.skipSearch) await prompter.note("Skipping search setup.", "Search");
		...
		const { setupSearch } = await import("./onboard-search-DgFrkXta.js");
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-Bi55Q3r-.js");
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	const { setupInternalHooks } = await import("./onboard-hooks-18pSl-in.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeSetupWizard } = await import("./setup.finalize-CYJldYfs.js");
