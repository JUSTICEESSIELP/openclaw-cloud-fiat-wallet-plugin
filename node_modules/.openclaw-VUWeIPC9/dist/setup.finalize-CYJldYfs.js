...
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-ClUkSaOY.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-DqkuHsEU.js";
import { f as resolveControlUiLinks, g as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-DFB9L0E6.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DKGi6xKz.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-DeQflIS4.js";
import { t as listConfiguredWebSearchProviders } from "./runtime-BiQlOaAl.js";
...
import { t as runTui } from "./tui-D6rrfUug.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CwworK7_.js");
	...
	const { describeCodexNativeWebSearch } = await import("./codex-native-web-search-DPDv-DAd.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DgFrkXta.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DgFrkXta.js");
