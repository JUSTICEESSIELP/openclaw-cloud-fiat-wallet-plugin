...
import { i as createConfigIO } from "./io-BIM51zl6.js";
...
import { d as trimToUndefined, n as isGatewaySecretRefUnavailableError } from "./credentials-C0z0_2gF.js";
import { i as parseStrictPositiveInteger } from "./parse-finite-number-HbZldjE_.js";
import { d as loadGatewayTlsRuntime } from "./call-h8FrADrE.js";
import { r as isWSLEnv } from "./wsl-Dc-yAjqT.js";
import { _ as inspectBestEffortPrimaryTailnetIPv4, f as resolveControlUiLinks, y as resolveBestEffortGatewayBindHostForDisplay } from "./onboard-helpers-DFB9L0E6.js";
import { c as resolveGatewayLogPaths } from "./launchd-DGaWDgZR.js";
import { r as resolveGatewayService } from "./service-DKGi6xKz.js";
import { a as inspectPortUsage, o as classifyPortListener, s as formatPortDiagnostics } from "./ports-D7rh6dgz.js";
import { t as killProcessTree } from "./kill-tree-CGzU-11F.js";
import { p as classifySystemdUnavailableDetail } from "./systemd-DeQflIS4.js";
import { a as filterDaemonEnv, c as pickProbeHostForBind, d as resolveRuntimeStatusColor, f as safeDaemonEnv, o as normalizeListenerAddress, s as parsePortFromArgs, t as createCliStatusTextStyles, u as renderRuntimeHints } from "./shared-BrUE0QAH.js";
import { d as resolveDaemonContainerContext, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-BNCoqy-f.js";
...
import { i as resolveGatewayProbeAuthWithSecretInputs } from "./probe-auth-DdtJs5LN.js";
...
async function probeGatewayStatus(opts) {
	try {
		const result = await withProgress({
			...
			if (opts.requireRpc) {
				const { callGateway } = await import("./call-COtvuyM0.js");
				await callGateway({
					url: opts.url,
					token: opts.token,
			...
			const { probeGateway } = await import("./probe-BzWCJQRo.js");
