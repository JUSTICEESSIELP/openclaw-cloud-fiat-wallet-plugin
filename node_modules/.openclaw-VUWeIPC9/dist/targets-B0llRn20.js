...
import { i as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context-CLP28cE0.js";
import { g as mapAllowFromEntries } from "./channel-config-helpers-BdJf9lkc.js";
import { n as resolveOutboundChannelPlugin, t as normalizeDeliverableOutboundChannel } from "./channel-resolution-BaZhA7Yr.js";
...
function parseExplicitTargetWithPlugin(params) {
	...
	return resolveOutboundChannelPlugin({ channel: provider })?.messaging?.parseExplicitTarget?.({ raw }) ?? null;
}
function resolveSessionDeliveryTarget(params) {
	...
	const hasTurnSourceThreadId = params.turnSourceThreadId != null && params.turnSourceThreadId !== "";
	...
	const turnToMatchesSession = !params.turnSourceTo || !context?.to || params.turnSourceTo === context.to;
	const lastThreadId = hasTurnSourceThreadId ? params.turnSourceThreadId : hasTurnSourceChannel && (params.turnSourceChannel !== sessionLastChannel || !turnToMatchesSession) ? void 0 : context?.threadId;
